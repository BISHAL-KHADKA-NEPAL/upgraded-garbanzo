...
const JobList = () => {
    ...
    useEffect(() => {
        const fetchJobs = async () => {
            try {
                const response = await fetch('https://gist.githubusercontent.com/BISHAL-KHADKA-NEPAL/c368c8ca15296267a60cd9d83f0de7ab/raw/abed517ad5b0893ef2c60c6f7d24ce3afa9f57d7/gistfile1.txt');
                if (!response.ok) {
        ...
        <section className="py-28">
            <div className="max-w-screen-lg mx-auto px-4 md:px-8">
                <div className="max-w-md">
                    <h1 className="text-gray-800 text-2xl font-extrabold sm:text-3xl mt-11">University Notes</h1>
                    <p className="text-gray-600 mt-2">Get Notes free of cost.</p>
                </div>
                {/* Search Input */}
                <div className="mt-4">
                    <input
